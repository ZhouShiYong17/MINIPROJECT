...
For our limitations, our dataset deals with active skills only, and does not include the passives. this may lead to some inaccuracies and misclassifications as passives also affects the abilities of a champion during the game. Hence, an improvement is to make use of datasets that include passives as well to have more information. <br>
